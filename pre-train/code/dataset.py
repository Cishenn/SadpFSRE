...
class SadpFSREDataset(data.Dataset):
    """Overwritten class Dataset for model SadpFSRE.

    This class prepare data for training of SadpFSRE.
    """
    def __init__(self, path, args):
        """Inits tokenized sentence and positive pair for SadpFSRE.
